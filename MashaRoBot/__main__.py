...
PM_START_TEXT = """
`Hellow` [🏇](https://telegra.ph/file/b092081ec5e54a91cf7f6.jpg) `My name is` *Mansiezz*
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD MANSIEZZ TO YOUR GROUP ➕️", url="t.me/ilham270_bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="💾 Credits", callback_data="source_"),
        InlineKeyboardButton(
            text="👥 SUPPORT", url="https://t.me/petercord"
        ),
    ],
]
...
HELP_STRINGS = """
`Hi.. I'm` [MANSIEZZ 🏇](https://telegra.ph/file/b092081ec5e54a91cf7f6.jpg)
...
def Masha_about_callback(update, context):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Mansiezz*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [🏇Pembuat](https://t.me/bismillahselaluadaa).
                 \n\nIf you have any question about Mansiezz, let us know at @bismillahselaluadaa.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🏇 I'm *Mansiezz*
                 \nHere is the [Penulis](http://t.me/bismillahselaluadaa) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
